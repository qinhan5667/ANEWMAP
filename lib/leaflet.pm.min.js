!(function (t) {
    ...
    var r = n(41),
      i = {
        ...
        _handleSnapping: function (t) {
          ...
          if ((this._snapList === undefined && this._createSnapList(t), this._snapList.length <= 0))
            return !1
          var n,
            r = t.target,
          ...
          if (
            (s.marker.fire('pm:snapdrag', s), this._layer.fire('pm:snapdrag', s), i.distance < o)
          ) {
            r.setLatLng(n), (r._snapped = !0)
            var l = this._snapLatLng || {},
              u = n || {}
            ;(l.lat === u.lat && l.lng === u.lng) ||
              ((e._snapLatLng = n), r.fire('pm:snap', s), e._layer.fire('pm:snap', s))
          } else
            this._snapLatLng &&
              (this._unsnap(s),
              (r._snapped = !1),
        ...
        _createSnapList: function () {
          ...
          r.off('pm:remove', this._handleSnapLayerRemoval, this),
            ...
            r.eachLayer(function (t) {
              if (
                (t instanceof L.Polyline || t instanceof L.Marker || t instanceof L.CircleMarker) &&
          ...
          return (
            e.forEach(function (e, i) {
              ...
              n.debugIndicatorLines[i].setLatLngs([t, a.latlng]),
                (r.distance === undefined || a.distance < r.distance) && ((r = a).layer = e)
            }),
            r
          )
        },
    ...
    ;(e.getCoord = function (t) {
      ...
      (e.featureOf = function (t, e, n) {
        ...
        if (!t.geometry || t.geometry.type !== e)
          throw new Error(
            'Invalid input to ' + n + ': must be a ' + e + ', given ' + t.geometry.type
          )
      }),
      (e.collectionOf = function (t, e, n) {
        ...
        for (var r = 0, i = t.features; r < i.length; r++) {
          ...
          if (!a.geometry || a.geometry.type !== e)
            throw new Error(
              'Invalid input to ' + n + ': must be a ' + e + ', given ' + a.geometry.type
            )
        }
      }),
  ...
  function (t, e, n) {
    !(function (t, n) {
      ...
      ;(n.prototype.rotateLeft = function (t) {
        var e = t.right
        e && ((t.right = e.left), e.left && (e.left.parent = t), (e.parent = t.parent)),
          t.parent
            ? t === t.parent.left
              ? (t.parent.left = e)
              : (t.parent.right = e)
        ...
        (n.prototype.rotateRight = function (t) {
          var e = t.left
          e && ((t.left = e.right), e.right && (e.right.parent = t), (e.parent = t.parent)),
            t.parent
              ? t === t.parent.left
                ? (t.parent.left = e)
                : (t.parent.right = e)
        ...
        (n.prototype.splay = function (t) {
          for (var e, n, r, i, a; t.parent; )
            (n = (e = t.parent).parent) && n.parent
              ? ((r = n.parent).left === n ? (r.left = t) : (r.right = t), (t.parent = r))
              ...
              t === e.left
                ? (n &&
                    (n.left === e
                      ? (e.right ? ((n.left = e.right), (n.left.parent = n)) : (n.left = null),
                        (e.right = n),
                        (n.parent = e))
                ...
                : (n &&
                    (n.right === e
                      ? (e.left ? ((n.right = e.left), (n.right.parent = n)) : (n.right = null),
                        (e.left = n),
                        (n.parent = e))
        ...
        (n.prototype.insert = function (t, e) {
          ...
          return (
            ...
            r ? (i(r.key, n.key) < 0 ? (r.right = n) : (r.left = n)) : (this._root = n),
            this.splay(n),
            this._size++,
            n
          )
        ...
        (n.prototype.remove = function (t) {
          ...
          if ((this.splay(e), e.left))
            if (e.right) {
              ...
              n.parent !== e &&
                (this.replace(n, n.right), (n.right = e.right), (n.right.parent = n)),
                this.replace(e, n),
                (n.left = e.left),
                (n.left.parent = n)
        ...
        (n.prototype.removeNode = function (t) {
          ...
          if ((this.splay(t), t.left))
            if (t.right) {
              ...
              e.parent !== t &&
                (this.replace(e, e.right), (e.right = t.right), (e.right.parent = e)),
                this.replace(t, e),
                (e.left = t.left),
                (e.left.parent = e)
        ...
        (n.prototype.erase = function (t) {
          ...
          if (e) {
            ...
            var n = e.left,
              r = e.right,
              i = null
            n && ((n.parent = null), (i = this.maxNode(n)), this.splay(i), (this._root = i)),
        ...
        (n.prototype.next = function (t) {
          ...
          if (e)
            ...
            else for (e = t.parent; e && e.right === t; ) (t = e), (e = e.parent)
          return e
        }),
        (n.prototype.prev = function (t) {
          ...
          if (e)
            ...
            else for (e = t.parent; e && e.left === t; ) (t = e), (e = e.parent)
          return e
        }),
      ...
      function p(t, e, n) {
        null === e
          ...
          : (t.isSubject === e.isSubject
              ...
              : ((t.inOut = !e.otherInOut), (t.otherInOut = e.isVertical() ? !e.inOut : e.inOut)),
            e && (t.prevInResult = !f(e, n) || e.isVertical() ? e.prevInResult : e)),
          (t.inResult = f(t, n))
      }
      function f(t, e) {
        switch (t.type) {
      ...
      function y(t, e, n) {
        ...
        return (
          g(t.point, t.otherEvent.point) && console.warn('what is that, a collapsed segment?', t),
      ...
      function L(t, e, n) {
        ...
        var l = [],
          ...
          c = !1
        return (
          g(t.point, e.point) ? (u = !0) : 1 === m(t, e) ? l.push(e, t) : l.push(t, e),
      ...
      function k(t, e) {
        ...
        return n[0] === r[0] && n[1] === r[1]
          ? ((n = t.otherEvent.point),
            ...
            n[0] === r[0] && n[1] === r[1] ? 0 : t.contourId > e.contourId ? 1 : -1)
          : 1 === m(t, e)
          ? 1
          : -1
      }
        ...
        var n,
          ...
          a = (function (t) {
            ...
            for (n = 0, r = a.length; n < r; n++)
              (e = a[n]).left || ((i = e.pos), (e.pos = e.otherEvent.pos), (e.otherEvent.pos = i))
            return a
          })(t),
          o = {},
          s = []
            ...
            for (l[0].push(p); h >= n; )
              (i = a[h]),
                ...
                i.left
                  ...
                  : ((i.otherEvent.resultInOut = !0), (i.otherEvent.contourId = u)),
                (o[(h = i.pos)] = !0),
                l[0].push(a[h].point),
                (h = M(h, a, o, n))
            ;(i = a[(h = -1 === h ? n : h)]),
          ...
          s = (function (t, e, n, r, i) {
            ...
            for (s = 0, l = e.length; s < l; s++)
              for (u = 0, h = (a = e[s]).length; u < h; u++)
                (o = 0 === u), i === c && (o = !1), o && B++, j(a[u], !1, B, p, r, o)
            return p
          })(t, e, a, o, r)
        return (i = (function (t, e, n, r, i) {
          ...
          return (
            (n[0] > r[2] || r[0] > n[2] || n[1] > r[3] || r[1] > n[3]) &&
              (i === l ? (a = D) : i === c ? (a = t) : (i !== u && i !== h) || (a = t.concat(e))),
            a
          )
        })(t, e, a, o, r))
          ? i === D
          ...
          : w(
              (function (t, e, r, i, a, o) {
                for (
                  ...
                  var _ = t.pop()
                  if ((d.push(_), (o === l && _.point[0] > g) || (o === c && _.point[0] > i[2])))
                    break
                  if (_.left) {
                    ;(u = s = f.insert(_)),
    ...
    function l(t, e) {
      s(t, function (t, n, i, a, o) {
        ...
        switch (l) {
          ...
          case 'LineString':
          case 'Polygon':
            return !1 !== e(r.feature(t, i, { bbox: a, id: o }), n, 0) && void 0
        }
        switch (l) {
          case 'MultiPoint':
            s = 'Point'
    ...
    ;(e.coordEach = i),
      ...
      (e.findPoint = function (t, e) {
        ...
        switch (n.type) {
          ...
          case 'Polygon':
            return (
              o < 0 && (o = u.length + o), s < 0 && (s = u[o].length + s), r.point(u[o][s], l, e)
            )
          case 'MultiLineString':
            return (
              a < 0 && (a = u.length + a), s < 0 && (s = u[a].length + s), r.point(u[a][s], l, e)
            )
          case 'MultiPolygon':
            return (
              a < 0 && (a = u.length + a),
  ...
  function (t, e) {
    t.exports = {
      ...
      repository: { type: 'git', url: 'git://github.com/codeofsumit/leaflet.pm.git' },
      author: {
        name: 'Sumit Kumar',
    ...
    var r = n(51),
      ...
      o = L.Class.extend({
        ...
        _fireDragModeEvent: function (t) {
          this.map.fire('pm:globaldragmodetoggled', { enabled: t, map: this.map })
        },
        ...
        layerAddHandler: function (t) {
          ...
          !!e.pm &&
            ...
            this.globalEditEnabled() && (this.disableGlobalEditMode(), this.enableGlobalEditMode()),
        ...
        _fireRemovalModeEvent: function (t) {
          this.map.fire('pm:globalremovalmodetoggled', { enabled: t, map: this.map })
        },
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modify the property information of the land parcel',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Informationen über Grundstückseigenschaften ändern',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modificare le informazioni sulle proprietà del terreno',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modificarea informaţiilor despre proprietăţile terenului',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Изменить информацию о свойствах участка',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modificar la información de los atributos de la parcela',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Informatie over perceeleigenschappen wijzigen',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modifier les informations sur les propriétés du lot',
  ...
  function (t, e) {
    t.exports = {
      ...
      actions: { finish: '完成', cancel: '取消', removeLastVertex: '移除最后的顶点' },
      buttonTitles: {
        drawMarkerButton: '绘制标记',
        drawPolyButton: '新增地块', // 绘制多边形
        editPolyInfoButton: '修改地块属性信息',
        drawLineButton: '绘制线段',
  ...
  function (t, e) {
    t.exports = {
      ...
      buttonTitles: {
        ...
        editPolyInfoButton: 'Modificar as informações das propriedades do lote',
    ...
    var a = L.Class.extend({
        ...
        var t = this.getButtons(),
          e = {
            geomanIcons: {
              ...
              editPolyInfo: 'control-icon leaflet-pm-icon-edit',
      ...
      triggerClickOnToggledButtons: function (t) {
        for (var e in this.buttons)
          this.buttons[e] !== t && this.buttons[e].toggled() && this.buttons[e]._triggerClick()
      },
      ...
      _defineButtons: function () {
        var t = this,
          ...
          z = {
            title: Object(i.a)('buttonTitles.editPolyInfoButton'),
            className: 'control-icon leaflet-pm-icon-edit',
            onClick: function () {
              console.log('editPolyInfo')
            },
            afterClick: function () {
              console.log('editPolyInfo')
            },
        ...
        this._addButton('drawMarker', new L.Control.PMButton(e)),
          ...
          this._addButton('editPolyInfo', new L.Control.PMButton(z)),
      ...
      _showHideButtons: function () {
        ...
        var t = this.getButtons()
        for (var e in t)
          this.options[e] && (t[e].setPosition(this.options.position), t[e].addTo(this.map))
      },
    })
    e.a = a
  },
    ...
    r.a.Marker = r.a.extend({
      ...
      _createMarker: function (t) {
        if (t.latlng) {
          ...
          n.addTo(this._map),
            n.pm.enable(),
            this._map.fire('pm:create', { shape: this._shape, marker: n, layer: n }),
    ...
    a.a.Line = a.a.extend({
      ...
      _createMarker: function (t, e) {
        ...
        return (
          ...
          e && this._hintMarker.setTooltipContent(Object(o.a)('tooltips.continueLine')),
          2 === this._layer.getLatLngs().length &&
            this._hintMarker.setTooltipContent(Object(o.a)('tooltips.finishLine')),
          n
        )
      },
    })
      ...
      _createMarker: function (t, e) {
        ...
        return (
          ...
          e &&
            ...
            this.options.snappable && this._cleanupSnapping()),
          e && this._hintMarker.setTooltipContent(Object(i.a)('tooltips.continueLine')),
          3 === this._layer.getLatLngs().length &&
            this._hintMarker.setTooltipContent(Object(i.a)('tooltips.finishPoly')),
          n
        )
      },
    })
    ...
    r.a.Rectangle = r.a.extend({
      ...
      _placeStartingMarkers: function (t) {
        ...
        L.DomUtil.addClass(this._startMarker._icon, 'visible'),
          ...
          this._hintMarker.setTooltipContent(Object(i.a)('tooltips.finishRect')),
    ...
    r.a.Circle = r.a.extend({
      ...
      _placeCircleCenter: function () {
        ...
        t &&
          ...
          this._hintMarker.setTooltipContent(Object(i.a)('tooltips.finishCircle')),
        ...
        Object.keys(n)
          ...
          .forEach(function (n) {
            ...
            i.addTo(e._map),
              ...
              e._map.fire('pm:cut', { shape: e._shape, layer: i, originalLayer: n }),
              (n._pmTempLayer = !0),
              (t._pmTempLayer = !0),
              n.remove(),
              t.remove(),
              0 === i.getLayers().length && e._map.pm.removeLayer({ target: i })
          })
      },
      _finishShape: function () {
        if (
  ...
  function (t, e, n) {
    ...
    s.a.Line = s.a.extend({
      ...
      _handleLayerStyle: function (t) {
        ...
        if (this.hasSelfIntersection()) {
          ...
          t
            ...
            this._layer.fire('pm:intersect', { intersection: i()(this._layer.toGeoJSON(15)) })
      ...
      _removeMarker: function (t) {
        ...
        if (a) {
          ...
          if (
            ...
            n._middleMarkerPrev && this._markerGroup.removeLayer(n._middleMarkerPrev),
            n._middleMarkerNext && this._markerGroup.removeLayer(n._middleMarkerNext),
            this._markerGroup.removeLayer(n),
            this.isPolygon()
              ? ((c = (s + 1) % f.length), (h = (s + (f.length - 1)) % f.length))
              : ((h = s - 1 < 0 ? undefined : s - 1), (c = s + 1 >= f.length ? undefined : s + 1)),
            c !== h)
          ) {
            var d = f[h],
              g = f[c]
          ...
          f.splice(s, 1),
            this._fireEdit(),
            this._layer.fire('pm:vertexremoved', { layer: this._layer, marker: n, indexPath: a })
        }
      },
      findDeepMarkerIndex: function (t, e) {
        ...
        var r = {}
        return (
          n && (r = { indexPath: n, index: n[n.length - 1], parentPath: n.slice(0, n.length - 1) }),
          r
        )
      },
      ...
      _onMarkerDragStart: function (t) {
        var e = t.target,
          n = this.findDeepMarkerIndex(this._markers, e).indexPath
        this._layer.fire('pm:markerdragstart', { markerEvent: t, indexPath: n }),
    ...
    r.a.Rectangle = r.a.Polygon.extend({
      ...
      _createMarker: function (t, e) {
        ...
        return (
          ...
          this.options.preventMarkerRemoval || n.on('contextmenu', this._removeMarker, this),
    ...
    r.a.Circle = r.a.extend({
      ...
      _moveCircle: function (t) {
        ...
        this._outerMarker.setLatLng(r),
          this._syncHintLine(),
          this._layer.fire('pm:centerplaced', { layer: this._layer, latlng: e })
      },
      _onMarkerDragStart: function (t) {
        this._layer.fire('pm:markerdragstart', { markerEvent: t })
      },
  ...
  function (t, e, n) {
    ...
    r.a.CircleMarker = r.a.extend({
      ...
      _onMarkerDragEnd: function (t) {
        this._layer.fire('pm:markerdragend', { markerEvent: t }), this._fireEdit()
      },
      _initSnappableMarkers: function () {
        var t = this._layer
        ;(this.options.snapDistance = this.options.snapDistance || 30),
