...
L.TileLayer.ChinaProvider.providers = {
    ...
    SiWei: {
        Satellite: {
            Map: "//swapi.siweiearth.com/sj_raster/v6/wmts/tile/10000201/1?ak={ak}&service=WMTS&request=GetTile&version=1.0.0&layer=&style=default&format=image/png&width=256&height=256&tileMatrix={z}&tileRow={y}&tileCol={x}",
        },
        QueryImage: {
            Map: "//swapi.siweiearth.com/sj_raster/v6/wmts/image_list_tile_mg/system?ak={ak}&image_list={image_list}&product_id:101&service=WMTS&request=GetTile&version=1.0.0&layer=&style=default&format=image/png&width=256&height=256&tileMatrix={z}&tileRow={y}&tileCol={x}",
        },
        Subdomains: [],
        key: "",
        ak: "",
